...
const CreateOperator = ({ users, setUsers, setView, openSubmenu }) => {
  ...
  const handleCreate = () => {
    ...
    setSuccessMessage("Operator successfully created");
  };
    ...
    <div className="">
      <div className="create-container-modal">
        <div className="create-container-card">
          ...
          <div className="header">
            <h2>Create BDC Operator</h2>
            <X size={18} className="close" onClick={() => setView("table")} />
          </div>
 
          <p>Enter the details of new BDC Operator</p>
      ...
      <div className="form-group mb-4">
        ...
        <div className="form-group">
          ...
          <input name="agentName" onChange={handleChange} placeholder="Enter Agent Name" />
        </div>
         <div className="form-group">
            <label>BDC Number</label>
          <input name="agentNumber" onChange={handleChange} placeholder="Enter Agent Number" />
        </div>
        </div>
         <div className="grid-2">
        <div className="form-group">
         ...
         <div className="grid-2">
        <div className="form-group">
            <label>BDC Contact</label>
          <input name="licenseNumber" onChange={handleChange} placeholder="BDC Contact" />
        </div>
         <div className="form-group">
            <label>Address</label>
