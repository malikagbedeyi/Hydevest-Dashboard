...
const isBoxSale = useMemo(() => {
  return selectedValues.some(
    c => presaleByContainerId[c.id]?.saleOption === "Box Sale"
  );
}, [selectedValues, presaleByContainerId]);

const isNonBoxSale = useMemo(() => {
  return selectedValues.some(
    c => presaleByContainerId[c.id]?.saleOption === "Split Sale"
  );
}, [selectedValues, presaleByContainerId]);
